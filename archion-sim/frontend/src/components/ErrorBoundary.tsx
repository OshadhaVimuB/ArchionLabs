    ...
    if (this.state.hasError) {
      return (
        <div className="flex h-screen w-screen items-center justify-center bg-background p-8">
          <div className="max-w-md rounded-2xl border border-border bg-card/90 p-8 text-center shadow-2xl backdrop-blur-md">
            ...
            {this.state.error && (
              <div className="mb-6 rounded-lg border border-border bg-secondary p-3 text-left">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 rounded-lg border border-border bg-secondary px-4 py-2.5 text-sm font-medium text-secondary-foreground transition hover:bg-accent"
              >
                Reload Page
              </button>
            </div>
