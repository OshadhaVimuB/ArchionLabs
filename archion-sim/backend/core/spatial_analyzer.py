...
This module provides tools to analyze the spatial context around a compliance violation,
including wall geometry, available space for relocation, and structural risk indicators.
"""
...
class NearbyWall:
    ...
    available_space_beyond_m: float
