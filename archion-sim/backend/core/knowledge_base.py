...
# ----- Regulatory citations per violation type. ------
...
def get_regulation_context(
    ...
    If building-type-specific regulation is not found, return the 'standard' regulation for that violation type.
    """
...
def classify_deficiency_level(
    ...
    For dimensional violations (corridor/door width, turning space), use percentage deviation from required value.
    """
    if required <= 0:
        return "moderate"
