"""
Compliance Checker Module, which evaluates building geometry and simulation data against 
...
class ComplianceChecker:
    ...
    def _deduplicate_violations(
        ...
        keeping only the one with the lowest measured_value (worst violation).
        """
        if not violations:
            return violations
        ...
        for i, vi in enumerate(violations):
            ...
            # Pick the worst violation from cluster
    ...
    def check_door_widths(
        ...
        """Find doors narrower than regulation minimum."""
